...
namespace HlslTools.Syntax
{
    public sealed class UnityPassSyntax : BaseUnityPassSyntax
    {
        ...
        public UnityPassSyntax(SyntaxToken passKeyword, SyntaxToken openBraceToken, List<SyntaxNode> statements, UnityCgProgramSyntax cgProgram, SyntaxToken closeBraceToken)
